...
static void ActiveMouseCB(int x, int y)
{
	s_pCallbacks->ActiveMouseCB(x, y);
}

static void MouseCB(int state, int button, int x,int y)
{
	s_pCallbacks->MouseMove(state, button, x, y);
}
