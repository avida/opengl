...
public:
    ...
    virtual void RenderSceneCB()
    {
		...
		/*
		m_red_scale += 0.001f;
		m_green_scale += 0.001f;
		m_blue_scale += 0.01f;
		m_directionalLight.Color.x = m_red_scale;
		m_directionalLight.Color.y = m_green_scale;
		m_directionalLight.Color.z = m_blue_scale;
		CIRCLE_SCALE(m_red_scale);
		CIRCLE_SCALE(m_green_scale);
		CIRCLE_SCALE(m_blue_scale);
		*/
        Pipeline p;
